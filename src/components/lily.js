...
class Lily extends Component {
  ...
  renderClubs = () => {
     ...
     return (
      <div> 
         <ul> 
             <a href = 'dtrade'> <li>Dartmouth Trading</li></a>
         </ul>
        </div>
     );
  }
  ...
  render() {
        ...
        <div className="profileinfoFake">
          <div>
            ...
            <div className="imgStyle">
              <img class="a" src="https://www.maxpreps.com/Gallery/7xXN6h52SUiWWWYMAy3Q6g/e109WFg1XUefvgPT25CHlA/1,315,600/polytechnic_vs_la_salle_girls_water_polo_thumbnail.jpg" width ="250" height="250"/>
            </div>
          </div>
          <div>
          </div>
          ...
          <div className="inputContainerFake">
            ...
            <div className="indivInput">
              <h6>lily.s.maechling.23@dartmouth.edu</h6>
            </div>
            <div className="indivInput">
              <h6>2023</h6>
            </div>
    ...
    <Button onClick={this.follow}>Request Lily as a Friend!</Button> 
        </div>
...
export default withRouter((Lily));